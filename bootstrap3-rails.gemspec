...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Add Bootstrap v3.2.0 to your rails app. See https://github.com/twbs/bootstrap/ for more information about Bootstrap v3.0.0 RC1.}
  spec.summary       = %q{Add Bootstrap v3.2.0 to your rails app.}
